...
<template>
    <div class="card">
        <div class=" flex pb-3">
            <Button type="button" icon="pi pi-plus" label="Add New Order" @click="toggle" />

            <OverlayPanel ref="op">
                <div class="flex flex-column gap-3 w-25rem p-3">
                    <p style="font-size: 1.5rem">Select A Customer</p>
...
export default {
    ...
    mounted() {
        ProductService.getCustomersMedium().then((data) => {
